...
class SymTrans(nn.Module):
    def __init__(self, feature_shape, n_heads, base_channel, down_ratio, vit_depth, patch_size, sr_ratio,
                 learning_mode):
...
class RegTran(nn.Module):
    def __init__(self, feature_shape, base_channel, down_ratio, vit_depth, patch_size, n_heads, sr_ratio, learning_mode,
        ...
        self.encoder_conv_1 = nn.Sequential(
            ...
            nn.Conv3d(base_channel // 2, base_channel // 2, 3, 1, 1, bias=False),
        ...
        self.decoder_conv_3 = nn.Conv3d(base_channel, base_channel // 2, 3, 1, 1, bias=True)

        self.flow1 = nn.Sequential(
            nn.Conv3d(base_channel // 2, base_channel // 2, 3, 1, 1, bias=True),
            nn.ReLU(),
